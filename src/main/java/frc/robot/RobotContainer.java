...
//    new JoystickButton(driverXbox, 3).whileTrue(new RepeatCommand(new InstantCommand(drivebase::lock, drivebase)));
    ...
    */
    ...
    armController.pov(90).onTrue(new ScoringCommand(score, Constants.ScoringPos.STORE).andThen(new WaitCommand(0.5)).andThen(new ClimbCommand(climbSub, 90)));
    ...
    driverController.y().onTrue(new ParallelCommandGroup(new TimedIntakeSetPowerCommand(score, 12, 0.75), new WaitCommand(0.1).andThen(new ScoringCommand(score, Constants.ScoringPos.CLIMB))));
