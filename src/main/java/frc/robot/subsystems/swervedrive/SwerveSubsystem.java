...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public SwerveSubsystem(File directory)
  {
    ...
    double angleConversionFactor = SwerveMath.calculateDegreesPerSteeringRotation(150.0 / 7.0, 1); // spark flex 7168 counts per rev
    // Motor conversion factor is (PI * WHEEL DIAMETER IN METERS) / (GEAR RATIO * ENCODER RESOLUTION).
    //  In this case the wheel diameter is 4 inches, which must be converted to meters to get meters/second.
    //  The gear ratio is 6.75 motor revolutions per wheel rotation.
    //  The encoder resolution per motor revolution is 1 per motor revolution.
    double driveConversionFactor = SwerveMath.calculateMetersPerRotation(Units.inchesToMeters(4), 5.90278, 1); //driveGearRatio used to be 6.75
    // calculate drive conversion factor by multiplying the ratios of each stage of gears (drive gear / driving gear)
   ...
   */
  public Command getAutonomousCommand(String pathName, boolean isAuto, boolean setOdomToStart)
  {
